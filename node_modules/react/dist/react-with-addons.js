...
if ("development" !== 'production') {
  ...
  var emptyAncestorInfo = {
    ...
    listQuoteTagAutoclosing: null,
    dlQuoteTagAutoclosing: null
  };
  ...
  var updatedAncestorInfo = function (oldInfo, tag, instance) {
    ...
    if (specialTags.indexOf(tag) !== -1 && tag !== 'address' && tag !== 'div' && tag !== 'p') {
      ancestorInfo.listQuoteTagAutoclosing = null;
      ancestorInfo.dlQuoteTagAutoclosing = null;
    }
    ...
    if (tag === 'li') {
      ancestorInfo.listQuoteTagAutoclosing = info;
    }
    if (tag === 'dd' || tag === 'dt') {
      ancestorInfo.dlQuoteTagAutoclosing = info;
    }
  ...
  var findInvalidAncestorForTag = function (tag, ancestorInfo) {
    switch (tag) {
      ...
      case 'li':
        return ancestorInfo.listQuoteTagAutoclosing;

      case 'dd':
      case 'dt':
        return ancestorInfo.dlQuoteTagAutoclosing;
